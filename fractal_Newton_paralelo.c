...
void distribuir_raices_y_reconstruir(RootStore *store, int rank, int size);
void escribir_datos_paralelo(int rank, int size, int cant_pixeles_locales, int *convergencia_raices_locales, int *cant_iteraciones_locales);
...
int main(int argc, char *argv[]) {
    ...
    distribuir_raices_y_reconstruir(&store, rank, size);
    ...
    escribir_datos_paralelo(rank, size, cant_pixeles_locales, convergencia_raices_locales, cant_iteraciones_locales);
